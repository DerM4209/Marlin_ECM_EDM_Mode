...
//
  ...
  #define TEMP_0_CS_PIN                       -1  // Don't use 53 if using Display/SD card (SDSS) or 49 (SD_DETECT_PIN)
#endif
...
#ifndef FILWIDTH_PIN
  #define FILWIDTH_PIN                         15  // Analog Input on AUX2
#endif
...
//
  ...
  #elif HAS_FREE_AUX2_PINS
    #define SPINDLE_LASER_ENA_PIN             -1  // Pullup or pulldown!
...
//////////////////////////
  ...
  //
      ...
      #define BTN_EN1                         -1  // https://files.panucatt.com/datasheets/viki_wiring_diagram.pdf explains -1/-1.
      #define BTN_EN2                         -1
      #define BTN_ENC                         -1
      ...
      #define BTN_ENC                EXP1_09_PIN
        ...
        #define LCD_BACKLIGHT_PIN             -1  // -1 (MKS mini12864 can't adjust backlight by software!)
      ...
      #define BEEPER_PIN                      -1
      // not connected to a pin
      #define LCD_BACKLIGHT_PIN               -1  // backlight LED on A11/D-1
